    ...
    if request.method == 'POST':
        ...
        if order_status == 'created':
            payment = Payment(
                ...
                total_price = response_payment['amount'],
                amount_paid = response_payment['amount_due'],
        ...
        # Move the cart items to Order Product table
            ...
            return HttpResponse('he', {'order_id':order_id, 'amount':amount})

    # return HttpResponse("no form")



def templatepayments(request):
